...
<body>
    ...
    <div>
        ...
        <button id="back" onclick="window.history.back();" class="btn btn-primary">Return to dashboard</button>
    </div>
    ...
    <script>
        ...
        function toggleEditing(enable) {
            if (enable) {
                document.querySelectorAll('*').forEach(element => {
                    if (element.tagName !== 'SCRIPT' && element.id !== 'cms-toolbar') {
        ...
        function saveEdits() {
            ...
            const elementsToHide = [cmsToolbar, startEditingButton, finishEditingButton];
